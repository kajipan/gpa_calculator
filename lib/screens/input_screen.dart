...
class _InputScreenState extends State<InputScreen> {
  ...
  final List<Course> _courses = [
    Course(name: 'Programming With Vector and Matrix', credits: 4, grade: 'A+'),
    Course(name: 'Artificial Intelligence', credits: 3, grade: 'B+'),
    Course(name: 'Big Data', credits: 2, grade: 'B'),
    Course(name: 'Python', credits: 3, grade: 'A'),
    Course(name: 'Mobile Application Development', credits: 3, grade: 'A-'),
    Course(name: 'Advanced Software Design', credits: 4, grade: 'B'),
  ];
        ...
        child: Column(
          children: [
            ...
            TextButton(
              ...
              child: Text("+ Add More Courses", style: TextStyle(color: Colors.blue)),
            ),
            SizedBox(height: 10),
            Row(
              children: [
